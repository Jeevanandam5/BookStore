      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 py-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/" className="hover:text-[#4F46E5] transition">Home</Link></li>
              <li><Link to="/book-collection" className="hover:text-[#4F46E5] transition">All Collection</Link></li>
              <li><Link className="hover:text-[#4F46E5] transition">About</Link></li>
              <li><Link className="hover:text-[#4F46E5] transition">Contact</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-300 mt-8 pt-5 text-center">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} BookStore — Built by{" "}
            <span className="text-[#4F46E5] font-semibold">BookStore</span>
          </p>
        </div>
      </div>
    </footer>
